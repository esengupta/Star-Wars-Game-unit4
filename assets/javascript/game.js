...
$(document).ready(function() {
  ...
  //audio clips
  let audio1 = new Audio('assets/audio/sound1.mp3');
  let audio2 = new Audio('assets/audio/sound2.mp3');
  let audio3 = new Audio('assets/audio/sound3.mp3');
  let audio4 = new Audio('assets/audio/sound4.mp3');
  let audio5 = new Audio('assets/audio/sound5.mp3');
  let audio6 = new Audio('assets/audio/sound6.mp3');
